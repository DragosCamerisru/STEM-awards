...
class DoctorProfileUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk','profile_doctor','profile_first_name','profile_last_name','hospital','adress_hospital','phone_number','caption','profile_picture','buletin_picture')
        read_only_fields = ['pk']
...
class PacientProfileUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('pk','profile_pacient','profile_first_name','profile_last_name','cnp','phone_number','caption','blood_transfuzion','profile_picture','buletin_picture','analize')
        read_only_fields = ['pk']
...
class CustomUserSerializator(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        ...
        fields = ('token','pk','is_pacient','is_doctor','firstname','lastname','email','password')
